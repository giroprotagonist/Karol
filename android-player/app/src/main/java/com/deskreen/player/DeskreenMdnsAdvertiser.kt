...
class DeskreenMdnsAdvertiser(private val context: Context) {
	...
	companion object {
		private const val TAG = "DeskreenMdnsAdvertiser"
		const val SERVICE_TYPE = "_deskreen-dj._tcp."
		const val SERVICE_NAME = "DeskreenPlayer"
	}
}
